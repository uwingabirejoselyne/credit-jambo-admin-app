      ...
      >
        <div className="h-full w-64 bg-green-600 shadow-xl">
          ...
          <div className="flex items-center gap-3 p-6 border-b border-white/20">
            ...
            <div>
              <h2 className="text-white font-bold text-lg">Credit Jambo</h2>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/20">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
